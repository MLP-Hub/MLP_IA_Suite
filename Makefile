...
SOURCES = \
	__init__.py \
	mlp_ia_suite.py mlp_ia_suite_dialog.py

PLUGINNAME = mlp_ia_suite

PY_FILES = \
	__init__.py \
	mlp_ia_suite.py mlp_ia_suite_dialog.py

UI_FILES = mlp_ia_suite_dialog_base.ui
...
QGISDIR=C:\Users\clair\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
