...
class MLP_IA_Suite:
    ...
    def run(self):
        ...
        self.dlg.SideBySide_pushButton.clicked.connect(lambda: sideBySide(canvas_list_1, self.dlg.PyLC_stack, [self.dlg.Swipe_toolButton, self.dlg.Transparency_slider], self.dlg.SideBySide_pushButton, self.dlg.SingleView_pushButton))
        self.dlg.SingleView_pushButton.clicked.connect(lambda: singleView(canvas_list_1, self.dlg.PyLC_stack, [self.dlg.Swipe_toolButton, self.dlg.Transparency_slider], self.dlg.SideBySide_pushButton, self.dlg.SingleView_pushButton))
        ...
        self.dlg.SideBySide_pushButton_2.clicked.connect(lambda: sideBySide(canvas_list_2, self.dlg.VP_stack, [self.dlg.Swipe_toolButton_2, self.dlg.Transparency_slider_2],self.dlg.SideBySide_pushButton_2, self.dlg.SingleView_pushButton_2))
        self.dlg.SingleView_pushButton_2.clicked.connect(lambda: singleView(canvas_list_2, self.dlg.VP_stack, [self.dlg.Swipe_toolButton_2, self.dlg.Transparency_slider_2],self.dlg.SideBySide_pushButton_2, self.dlg.SingleView_pushButton_2))
        ...
        self.dlg.SideBySide_pushButton_3.clicked.connect(lambda: sideBySide(canvas_list_4, self.dlg.AL_stack,  [self.dlg.Swipe_toolButton_3, self.dlg.Transparency_slider_3],self.dlg.SideBySide_pushButton_3, self.dlg.SingleView_pushButton_3))
        self.dlg.SingleView_pushButton_3.clicked.connect(lambda: singleView(canvas_list_4, self.dlg.AL_stack, [self.dlg.Swipe_toolButton_3, self.dlg.Transparency_slider_3],self.dlg.SideBySide_pushButton_3, self.dlg.SingleView_pushButton_3))
